...
export const ReverseStrategyPage = () => {
  ...
  const [protectSide, setProtectSide] = useState<"long" | "short">("short");
  ...
  return (
    <main className="mx-auto mt-8 max-w-6xl px-4">
      ...
      <section className="mb-6 rounded-2xl border border-violet-500/25 bg-gradient-to-br from-slate-950/80 via-slate-950/50 to-slate-900/60 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.85)]">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="max-w-md">
            <p className="inline-flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-violet-300/90">
              Position protection
              <span className="h-[1px] w-10 bg-violet-500/60" />
            </p>
            <h3 className="mt-1 text-sm font-semibold text-slate-50">One-click TP / SL triggers</h3>
            <p className="mt-1 text-xs leading-relaxed text-slate-400">
              Create independent <span className="font-semibold text-slate-100">STOP_MARKET</span> closes for your active position on{" "}
              <span className="font-mono text-[11px] text-slate-100">{symbol}</span>.
            </p>
          </div>
          <div className="flex flex-1 flex-col gap-4 rounded-xl border border-violet-500/25 bg-slate-950/60 px-3 py-3 md:px-4">
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="space-y-1.5 lg:col-span-2">
                <label className="text-[11px] font-medium uppercase tracking-wide text-slate-400">Size</label>
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="absolute inset-y-0 right-1 my-1 flex items-center rounded-md px-2.5 text-[11px] font-semibold text-violet-100 hover:text-violet-200 disabled:opacity-60"
            ...
            <div className="mt-1 flex flex-wrap items-center gap-3 border-t border-violet-500/20 pt-3">
              <button
                type="button"
